...
When using **Audited** attribute on **entity** class, **EntityChange will always be created** for entity in *Added/Modified/Deleted* state, regardless of whether any **PropertyChange** is being created.

Similarly, when using **Audited** attribute on a **property**, **PropertyChange will always be created** for entity in *Added/Modified/Deleted* state, regardless of whether there is any differences between the **new and old values** of the **property**.
