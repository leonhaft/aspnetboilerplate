...
using AdventureWorks.Web.Models.Account;
using AdventureWorks.Web.Views.Shared.Components.TenantChange;

namespace AdventureWorks.Web.Controllers
{
    public class AccountController : AdventureWorksControllerBase
    {
